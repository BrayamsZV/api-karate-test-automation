Feature: Create new pets
  ...
  Scenario: Create a new dog
    #Given url "http://localhost:3000/pets"
    #Given url baseUrl
    #And print "la url es: ", baseUrl
    #And print "el apiKey es: ", apiKey
    #And print "el userId es: ", userId
    #And path 'pets'
    #And request { "name": "Bingo3", "type": "Perro", "age": 1}
  ...
  Scenario Outline: Create a new pet with <description>
    ...
    Examples:
      ...
      | Bluey 1 hhhhhhhhhh | Perro | 1   | long name          | 201            | Pet created     |
